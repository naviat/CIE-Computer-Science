...
While working with pseudocode, I was disappointed by the lack of an editor (that uses CIE syntax). So I built my own plugin for the popular editor [Notepad++](https://notepad-plus-plus.org/).
...
1. Download the ZIP folder that has the installation files, and then extract them. You should find five files, which you'll use for the installing my plug-in in Notepad++.
    ...
    [Download](https://downgit.evecalm.com/#/home?url=https://github.com/naviat/NPP_Pseudo-Highlight/tree/main/npp-psu-plugin){: .btn .btn-purple }
